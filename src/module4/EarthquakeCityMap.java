...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(255));
		rect(50,175,12,12,12);
		rect(50,225,12,12);
		
		fill(255,255,51);
		rect(50, 300, 12, 12, 12);
		fill(0,0,255);
		rect(50, 340, 12, 12, 12);
		fill(255, 0, 0);
		rect(50, 380, 12, 12, 12);
		fill(255);
		rect(50, 420, 12, 12, 12);
		...
		text("Land Quake", 75, 180);
		text("Ocean Quake", 75, 230);
		textSize(14);
		text("Size % Magnitude", 45, 260);
		textSize(12);
		text("Shallow", 75, 300);
		text("Intermediate", 75, 340);
		text("Deep", 75, 380);
		text("Past Hour", 75, 420);
		/*
	...
	private void printQuakes() 
	{
		...
		System.out.println("Oceanquakes: "+ oceanquake);
